    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        when (call.method) {
            "getInstalledApps" -> {
                ...
                val excludeUnlaunchableApps = call.argument("exclude_unlaunchable") ?: true
                ...
                Thread {
                    val apps: List<Map<String, Any?>> =
                        getInstalledApps(excludeSystemApps, excludeUnlaunchableApps, withIcon, packageNamePrefix, PlatformType.fromString(platformTypeName))
                    result.success(apps)
                }.start()
            }
